...
const StudentAssignment = () => {
  const [inputdata, setInputdata] = useState<InputInter>({ student_class: "", studentid: "" });
...
if(value===""){
  ...
  return (
    <>
      ...
      {
       allassignments&& allassignments.length>0 &&<Select   value={maxassignment} onChange={(value)=>changeAssignmentLimit(value.toString())}     className='selection'>
    ...
    {
      allassignments && allassignments.length>0&&  <AssignmentPagination page={page} setPage={setPage} data={allassignments} maxlimit={maxassignment} />
    }
