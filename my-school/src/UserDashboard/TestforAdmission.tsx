...
import quizdata from "../Components/data.json"
import Congratulations from "../Components/Congratulations"
import { Button } from 'antd'
const Test = ({setCurrentStatus,currentStatus,addformdata}:{setCurrentStatus:(currentStatus:number)=>void,currentStatus:number,addformdata:(score:number)=>void}) => {
